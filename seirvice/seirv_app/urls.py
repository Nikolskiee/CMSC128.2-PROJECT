...
urlpatterns = [
    ...
    path('download/infectious/<pk>', views.download_infectious_pdf, name='download_infectious_pdf'),
    path('download/dengue/<pk>', views.download_dengue_pdf, name='download_dengue_pdf'),
